...
function App() {
  ...
  return (
    <View style={{ margin: 30 }}>
      ...
      <Text style={{ fontSize: 17, fontFamily: 'JakartaSansBold', color: 'white', right: 30}}>Members</Text>
      <SelectBox
        label=""
        options={K_OPTIONS}
        ...
        isMulti
        inputPlaceholder={'e.g. "Ho Sae Young"'}
        ...
        optionContainerStyle={{backgroundColor: 'rgba(255, 255, 255, 0.25)', borderRadius: 2}}
        inputFilterContainerStyle={{backgroundColor: 'rgba(255, 255, 255, 0.25)', borderRadius: 2}}
     />
    </View>
  )
